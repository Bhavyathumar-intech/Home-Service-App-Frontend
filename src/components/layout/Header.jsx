...
//         <svg className="h-6 w-6 text-indigo-500" viewBox="0 0 40 40" fill="currentColor">
...
//         </svg>
//         <span className="ml-2 text-2xl font-bold text-gray-900">Home Service App</span>
//       </Link>

//       {/* Navigation Links */}
//       <nav className="hidden md:flex space-x-6">
//         <Link to="/" className="text-gray-700 hover:text-indigo-600 transition duration-200">Home</Link>
//         <Link to="/services" className="text-gray-700 hover:text-indigo-600 transition duration-200">Services</Link>
//         <Link to="/about" className="text-gray-700 hover:text-indigo-600 transition duration-200">About</Link>
//         <Link to="/contact" className="text-gray-700 hover:text-indigo-600 transition duration-200">Contact</Link>
//       </nav>

//       {/* Sign In / Sign Up Buttons */}
//       <div className="flex space-x-4">
//         <Link to="/login" className="px-4 py-2 rounded-lg text-gray-700 hover:text-indigo-600 transition duration-200">
//           Sign in
//         </Link>
//         <Link to="/register" className="px-4 py-2 rounded-lg text-white bg-indigo-600 hover:bg-indigo-500 transition duration-200 shadow-md">
//           Sign up
//         </Link>
//       </div>
//     </header>
